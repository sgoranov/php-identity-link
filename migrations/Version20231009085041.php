 ...
 */
final class Version20231009085041 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE access_token (id UUID NOT NULL, client_id UUID DEFAULT NULL, identifier TEXT NOT NULL, user_identifier VARCHAR(255) NOT NULL, expiry_date_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_revoked BOOLEAN NOT NULL, scopes TEXT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE auth_code (id UUID NOT NULL, client_id UUID DEFAULT NULL, identifier TEXT NOT NULL, user_identifier VARCHAR(255) NOT NULL, expiry_date_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, redirect_uri VARCHAR(500) NOT NULL, scopes TEXT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE client (id UUID NOT NULL, identifier VARCHAR(100) NOT NULL, name VARCHAR(100) NOT NULL, redirect_uri VARCHAR(500) NOT NULL, is_confidential BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE grant_type (id UUID NOT NULL, client_id UUID DEFAULT NULL, grant_type VARCHAR(25) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_4E46944919EB6921 ON grant_type (client_id)');
        $this->addSql('COMMENT ON COLUMN grant_type.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN grant_type.client_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE grant_type ADD CONSTRAINT FK_4E46944919EB6921 FOREIGN KEY (client_id) REFERENCES client (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE grant_type DROP CONSTRAINT FK_4E46944919EB6921');
        ...
        $this->addSql('DROP TABLE grant_type');
